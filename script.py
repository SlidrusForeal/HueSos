...
# Настройки
CLICKBAIT_TITLE = "😱 ШОК СОССКИЙ ХОМЯК ВЫПУСТИЛ СОСМАРККОМБАТ..."
CLICKBAIT_DESCRIPTION = "🔥 Эксклюзив! Это должно было остаться в секрете, но утекло из херванусстудио. Скорее смотри, пока не удалили!"
